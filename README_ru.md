...
*(Здесь можно вставить график зависимости времени/ускорения от числа потоков для реализации на pthreads.)*
...
*(Здесь можно вставить график масштабируемости для реализации на C/MPI.)*
...
*(Здесь можно вставить график времени выполнения для реализации на Python/mpi4py.)*
...
*(Здесь можно вставить график времени/ускорения для реализации на OpenMP.)*
