...
![График масштабирования pthreads](docs/graphics/pthreads.png)

![График real-времени pthreads](docs/graphics/pthreads_only_real.png)
...
![График масштабирования C/MPI](docs/graphics/c_mpi.png)


![График real-времени C/MPI](docs/graphics/c_mpi_only_real.png)
...
![График масштабирования Python MPI](docs/graphics/py_mpi.png)

![График real-времени Python MPI](docs/graphics/py_mpi_only_real.png)
...
![График масштабирования OpenMP](docs/graphics/omp.png)

![График real-времени OpenMP](docs/graphics/omp_only_real.png)
